...
export const RU = {
  ...
  'process.summary.updatedAgo': '{duration} назад',
  'process.member.activeCards': 'Активных: {count}',
  'process.member.longest': 'Дольше всего: {duration}',
  'process.stage.member': 'Мембер',
  'process.stage.scripts': 'Скрипты',
  'process.stage.files': 'Файлы',
  'process.stage.gateway': 'Шлюз',
  'process.card.status': 'Статус',
  'process.card.updated': 'Обновлено',
  'process.card.worker': 'Worker #{id}',
  'process.card.records': 'Строк: {count}',
  'process.card.queueWait': 'Ожидание worker: {duration}',
  'process.card.execution': 'Выполнение: {duration}',
  'process.card.file': 'Файл',
  'process.card.chunk': 'Чанк #{number}',
  'process.card.rows': 'Строк: {count}',
  'process.card.size': 'Размер: {size}',
  'process.card.writeElapsed': 'Запись: {duration}',
