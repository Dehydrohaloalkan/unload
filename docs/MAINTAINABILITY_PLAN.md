...
- [ ] Добавить store-level тесты конкурентных обновлений и аварийного восстановления.
...
- Штатный VSTest проходит: 100/100 относящихся к плану tests passed.
...
> Сделать ошибку записи persistence наблюдаемой для вызывающего приложения: сначала зафиксировать
> контракт тестом, затем перестать поглощать исключение после обязательного error log.
